...
excel_data = OperateExcel(r"\test_data\AssetManagement\common\common.xlsx",
                          sheet_name="Product_Quotation_Type").read_excel_data()

@ddt
class Test_Product_Quotation_Type(unittest.TestCase):
    ...
    def test_product_quotation_type(self,item):
        ...
        OperateExcel(r"\test_data\AssetManagement\common\common.xlsx",
                    sheet_name="Product_Quotation_Type").write_excel_data(item["case_id"] + 1,str(res),
                                                                    test_result)
