...
excel_data = OperateExcel(r"\test_data\AssetManagement\common\common.xlsx", sheet_name="product_quotation_type").read_excel_data()

@ddt
class Testproduct_quotation_type(unittest.TestCase):
    ...
    def test_product_quotation_type(self,item):
        ...
        try:
            ...
            OperateExcel(r"\test_data\AssetManagement\common\common.xlsx",
                            sheet_name="product_quotation_type").write_excel_data(item["case_id"] + 1,str(res),test_result)
