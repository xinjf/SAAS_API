...
excel_data = OperateExcel(r"C:\Users\pujun\Desktop\APIAuto_unittest\test_data\AssetManagement\firm\firm.xlsx", sheet_name="AddFirm").read_excel_data()
...
class Test_AddFirm(unittest.TestCase):
    ...
    def test_01(self,item):
        ...
        try:
            ...
            OperateExcel(r"C:\Users\pujun\Desktop\APIAuto_unittest\test_data\AssetManagement\firm\firm.xlsx", sheet_name="AddFirm").write_excel_data(item["case_id"] + 1,str(res),Test_result)
