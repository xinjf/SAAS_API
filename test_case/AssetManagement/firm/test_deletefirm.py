...
excel_data = OperateExcel(r"C:\Users\pujun\Desktop\APIAuto_unittest\test_data\AssetManagement\firm\firm.xlsx", sheet_name="DeleteFirm").read_excel_data()

@ddt
class Test_DeleteFirm(unittest.TestCase):
    ...
    def test_01(self,item):
        ...
        try:
            ...
            OperateExcel(r"C:\Users\pujun\Desktop\APIAuto_unittest\test_data\AssetManagement\firm\firm.xlsx", sheet_name="DeleteFirm").write_excel_data(item["case_id"] + 1,str(res),Test_result)
