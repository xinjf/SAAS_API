...
excel_data = OperateExcel(r"\test_data\AssetManagement\flow\flow.xlsx", sheet_name="Sheet2").read_excel_data()
    ...
    def test_sheet2(self,item):
        ...
        try:
            ...
            OperateExcel(r"\test_data\AssetManagement\flow\flow.xlsx",
                            sheet_name="Sheet2").write_excel_data(item["case_id"] + 1,str(res),test_result)
